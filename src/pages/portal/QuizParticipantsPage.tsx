...
import { Download, Search, ShieldAlert, CheckCircle, XCircle, Filter, Trash2 } from 'lucide-react';
...
export const QuizParticipantsPage: React.FC = () => {
  ...
  const handleDeleteParticipant = async () => {
    ...
    try {
      await api.deleteQuizParticipant(participantToDelete.id);
  ...
  return (
    <PortalLayout currentModule="quiz_participants" title="Participant Submissions">
      <div className="space-y-6">
        ...
        {/* MODAL: Confirm Delete Participant Submission */}
        <ConfirmModal
          isOpen={!!participantToDelete}
          onClose={() => setParticipantToDelete(null)}
          onConfirm={handleDeleteParticipant}
          title="Delete Quiz Submission"
          message={`Are you sure you want to permanently delete submission #${participantToDelete?.participantNumber} (ID: ${participantToDelete?.normalizedIdNumber || participantToDelete?.idNumber || participantToDelete?.maskedIdNumber})? This cannot be undone.`}
